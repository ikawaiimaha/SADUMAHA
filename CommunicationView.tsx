  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-sadu-linen border border-sadu-gold rounded-lg p-6 shadow-xs">
        ...
        <div className="mt-4 p-3.5 bg-sadu-paper border-s-4 rtl:border-s-0 rtl:border-e-4 border-sadu-ink text-xs leading-relaxed">
            ...
            return (
              <div
                ...
                className={`p-4 rounded-md border transition-all ${
                  isMe
                    ? 'bg-sadu-sand border-sadu-gold me-6 rtl:me-0 rtl:ms-6'
                    : 'bg-sadu-paper border-sadu-gold ms-6 rtl:ms-0 rtl:me-6'
                }`}
              >
