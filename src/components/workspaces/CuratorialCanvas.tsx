...
export const CuratorialCanvas: React.FC = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative grid min-h-[480px] gap-4 overflow-hidden rounded-lg border-2 border-sadu-gold/60 bg-[#fdfbf7] p-4 lg:grid-cols-[1.5fr_1fr]">
        ...
        <section className="z-10 flex flex-col rounded border-2 border-dashed border-sadu-ink/40 bg-white/60 p-4 transition-all hover:bg-white/80">
