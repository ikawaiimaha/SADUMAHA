...
export const CommitteeView: React.FC<CommitteeViewProps> = (props) => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300 pb-12">
      ...
      {viewMode === 'builder' ? <ArtistNominationBuilder lang={lang} onSuccess={() => setViewMode('dossier')} onCancel={() => setViewMode('dossier')} /> : <div className="mx-auto max-w-5xl space-y-8">
