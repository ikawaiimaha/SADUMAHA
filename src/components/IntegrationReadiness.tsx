...
const readiness = [
  { id: 'identity', en: 'UAE PASS', ar: 'الهوية الرقمية UAE PASS', statusEn: 'Not connected', statusAr: 'غير متصل', detailEn: 'The role switcher is a demonstration, not authenticated sign-in.', detailAr: 'اختيار الدور للتجربة فقط، وليس تسجيل دخول موثقاً.' },
  ...
  { id: 'finance', en: 'Finance API', ar: 'واجهة الربط المالي', statusEn: 'Not connected', statusAr: 'غير متصل', detailEn: 'No payment service or financial authorization is implemented.', detailAr: 'لا توجد خدمة دفع أو آلية تفويض مالي منفذة.' },
