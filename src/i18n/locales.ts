...
export const LOCALES: Record<Language, Translations> = {
  en: {
    ...
    navigation: {
      ...
      architecturalDrawer: 'Presentation Notes',
    ...
    commandPalette: {
      ...
      filterHint: 'Filter',
      workflows: {
        archiveTitle: 'Open archive and record context',
        archiveSubtitle: "Sample closeout checklist; no cryptographic audit or certificate",
        ...
        communicationsSubtitle: "Sample conversation; messages are not transmitted or durably stored",
      ...
      actions: {
        ...
        presenterTitle: 'Open Presentation Notes',
        presenterSubtitle: 'Architectural canon, audit matrix M01-M08, and RACI governance',
        personasTitle: 'Open proposed portfolio oversight',
        personasSubtitle: 'Dated manager reports and escalated risks; unreported progress stays unknown',
    ...
    contracts: {
      modalTitle: 'Sample contract request preview',
      modalBadge: 'Institutional Fast Action · Shortcut ⌥N',
      institutionalTag: 'DEMO-CONTRACT-v1.2',
      ...
      advanceOption20: 'Sample: 20% advance',
      advanceOption30: 'Sample: 30% advance (demo default)',
      advanceOption50: 'Sample: 50% advance; no exception authority established',
      section4Title: 'Proposed scope condition — no verified clause',
      section4Desc: 'Check the applicable agreement; no exclusion right is established here.',
      gateMilestone2Title: 'Proposed sample review dependency',
      gateMilestone2Desc: 'Design assumption only; does not determine payment entitlement.',
      validationNotice: 'Unapproved scenario; authority unverified',
      cancelBtn: 'Cancel',
      submitBtn: 'Create sample preview',
      submittingBtn: 'Preparing local preview...',
      successTitle: 'Local sample request preview created',
      successDesc: 'No contract was registered, transmitted or executed. This preview resets when closed.',
      firstPartyLabel: 'First Party:',
      secondPartyLabel: 'Second Party:',
      initialStateLabel: 'Initial State:',
      initialStateVal: 'Sample draft — no legal review performed',
      jumpToLedgerBtn: 'Jump to Contracts Register →',
      types: {
        master: {
          title: 'Solo Exhibition Master Participation Agreement',
          desc: 'Illustrative agreement structure; rights and authority unverified.',
          codePrefix: 'SCB-CTR-2026',
        },
        schedule: {
          title: 'Form 1(B): Approved Artwork Schedule Annex',
          desc: 'Sample dimensional and technical specifications; no binding annex.',
          codePrefix: 'SCB-SCH-2026',
        },
        covenant: {
          title: 'Consignment, Bailment & Right of Exclusion Covenant',
          desc: "Illustrative contract record; no execution or legal authority is established.",
          codePrefix: 'SCB-COV-2026',
        },
        milestone: {
          title: 'Production Honorarium Milestone Disbursement Covenant',
          desc: 'Illustrative milestone dependency; no payment authorization.',
          codePrefix: 'SCB-HON-2026',
        },
        logistics: {
          title: 'Freight Manifest, Customs Bond & Transit Indemnity',
          desc: "Sample transport manifest with illustrative values and condition reports.",
    ...
    coordinator: {
      ...
      evidenceScoreSubtitle: 'Sample completeness measure; no institutional threshold verified',
      filters: {
        all: 'All Disciplines',
    ...
    leadership: {
      ...
      delegationMatrixTitle: "Proposed authority and delegation review",
    ...
    operations: {
      ...
      ibanValidationLabel: "Sample payment details · not bank-verified",
    },
    archive: {
      sovereignTitle: "Sample cultural record and archive",
      sovereignSubtitle: "Session-only archive demonstration; long-term preservation is not implemented.",
      centuryPreservation: "Proposed long-term preservation",
      immutableHash: "Illustrative record reference · not a computed hash",
      manifestVerification: "Sample document manifest",
      closeoutManifestPoints: 'Archive closeout checklist',
      tamperAuditTitle: "Sample references · no cryptographic audit",
      sealCertificateTitle: "Sample closeout summary · not a certificate",
    },
    communications: {
      title: "Sample communication workspace",
      subtitle: "Sample coordinator–artist conversation; no transmission or durable audit record.",
      attributableGateway: "Sample message preview",
      tamperEvidentNotice: "Messages remain temporary in the browser; no cryptographic record is created.",
    ...
    dossiers: {
      ...
      subtitle: 'Anonymized selection records, conflict disclosures, and committee approval conditions',
  ...
  ar: {
    ...
    commandPalette: {
      ...
      filterHint: 'تصفية',
      workflows: {
        archiveTitle: "فتح الأرشيف التجريبي وسياق السجل",
        archiveSubtitle: "قائمة إغلاق تجريبية؛ دون تدقيق تشفيري أو شهادة",
        archiveBadge: 'قفز سريع',
        newContractTitle: 'معاينة طلب عقد تجريبي جديد',
        ...
        communicationsSubtitle: "محادثة تجريبية؛ لا تُرسل الرسائل ولا تُحفظ بصورة دائمة",
        ...
        exportPdfSubtitle: 'تقرير تجريبي للطباعة؛ ليس وثيقة رسمية أو سجلاً دائماً',
      ...
      actions: {
        ...
        personasTitle: 'فتح الإشراف المقترح على البرامج',
        personasSubtitle: 'تقارير المديرين المؤرخة والمخاطر المصعّدة؛ يبقى التقدم غير المبلغ عنه غير معلوم',
        densityTitle: 'تبديل كثافة العرض (مريح / مكثف)',
        densitySubtitle: 'ملاءمة مساحات القراءة للمكاتب الأرشيفية والتحليلية',
      },
    },
    contracts: {
      modalTitle: 'معاينة طلب عقد تجريبي',
      ...
      advanceOption20: 'مثال: دفعة مقدمة 20%',
      advanceOption30: 'مثال: دفعة مقدمة 30% (افتراضي تجريبي)',
      advanceOption50: 'مثال: دفعة مقدمة 50%؛ لم تُثبت صلاحية استثناء',
      section4Title: 'شرط نطاق مقترح — لا بند موثق',
      section4Desc: 'يلزم فحص الاتفاق المنطبق؛ لا يُثبت هنا حق استبعاد.',
      gateMilestone2Title: 'اعتماد مرحلي تجريبي مقترح',
      gateMilestone2Desc: 'افتراض تصميمي فقط؛ لا يحدد استحقاق الدفع.',
      validationNotice: 'سيناريو غير معتمد؛ التفويض غير موثق',
      cancelBtn: 'إلغاء',
      submitBtn: 'إنشاء معاينة تجريبية',
      submittingBtn: 'جارٍ إعداد المعاينة المحلية...',
      successTitle: 'تم إنشاء معاينة طلب محلي تجريبي',
      successDesc: 'لم يُسجل عقد أو يُرسل أو يُنفذ. تنتهي هذه المعاينة عند إغلاقها.',
      firstPartyLabel: 'الطرف الأول:',
      secondPartyLabel: 'الطرف الثاني:',
      initialStateLabel: 'المرحلة المبدئية:',
      initialStateVal: 'مسودة تجريبية — لم تُجرَ مراجعة قانونية',
      jumpToLedgerBtn: 'الانتقال إلى سجل العقود ←',
      types: {
        master: {
          title: 'عقد المشاركة الفنية الرئيسي بالمعرض الشخصي',
          desc: 'هيكل اتفاق توضيحي؛ الحقوق والصلاحيات غير موثقة.',
          codePrefix: 'SCB-CTR-2026',
        },
        schedule: {
          title: 'ملحق جدول الأعمال الفنية المعتمدة نموذج 1 (ب)',
          desc: 'مواصفات فنية وهندسية تجريبية؛ لا ملحق ملزماً.',
          codePrefix: 'SCB-SCH-2026',
        },
        covenant: {
          title: 'ميثاق الأمانة والإعارة وحق الاستبعاد النظامي',
          desc: "سجل عقد توضيحي؛ لا يُثبت تنفيذاً أو صلاحية قانونية.",
          codePrefix: 'SCB-COV-2026',
        },
        milestone: {
          title: 'اتفاقية صرف الدفعة الإنتاجية للمكافأة الفنية',
          desc: 'علاقة مرحلية توضيحية؛ لا تفويض بالدفع.',
          codePrefix: 'SCB-HON-2026',
        },
        logistics: {
          title: 'بوليصة الشحن الجوي والضمان الجمركي والتأمين',
          desc: "قائمة نقل تجريبية بقيم وتقارير حالة توضيحية.",
          codePrefix: 'SCB-LOG-2026',
        },
      },
    },
    coordinator: {
      ...
      evidenceScoreSubtitle: 'مقياس اكتمال تجريبي؛ لا حد مؤسسي موثق',
      filters: {
        all: 'كافة التخصصات',
    ...
    leadership: {
      ...
      delegationMatrixTitle: "مراجعة صلاحيات وتفويضات مقترحة",
    ...
    operations: {
      ...
      ibanValidationLabel: "بيانات دفع تجريبية · دون تحقق مصرفي",
    },
    archive: {
      sovereignTitle: "سجل ثقافي وأرشيف تجريبيان",
      sovereignSubtitle: "عرض أرشيفي في الجلسة فقط؛ لم يُنفذ الحفظ طويل الأجل.",
      centuryPreservation: "حفظ طويل الأجل مقترح",
      immutableHash: "مرجع سجل توضيحي · ليس بصمة محسوبة",
      manifestVerification: "قائمة مستندات تجريبية",
      closeoutManifestPoints: "قائمة إغلاق أرشيف تجريبية",
      tamperAuditTitle: "مراجع تجريبية · دون تدقيق تشفيري",
      sealCertificateTitle: "ملخص إغلاق تجريبي · ليس شهادة",
    },
    communications: {
      title: "مساحة مراسلات تجريبية",
      subtitle: "محادثة تجريبية بين المنسق والفنان؛ لا إرسال أو سجل تدقيق دائم.",
      attributableGateway: "معاينة رسائل تجريبية",
      tamperEvidentNotice: "تبقى الرسائل مؤقتة في المتصفح؛ لا يُنشأ سجل تشفيري.",
