...
const programmeReferences: Omit<PortfolioActivity, 'forecast' | 'escalated'>[] = [
  ...
  },
  {
    ...
    area: 'awards',
    scope: 'programme-reference',
    source: 'poetryCriticism',
    activityEn: 'Sharjah Award for Arabic Poetry Criticism',
    activityAr: 'جائزة الشارقة لنقد الشعر العربي',
    outputEn: 'Research-cycle milestones and documented outcomes',
    outputAr: 'مراحل الدورة البحثية وتوثيق المخرجات',
  },
  ...
  },
  {
    id: 'REF-MAGAZINES',
    area: 'publishing',
    scope: 'department-output',
    source: 'calendar',
    activityEn: 'Department Magazines & Literary Periodicals',
    activityAr: 'مجلات دائرة الثقافة والدوريات الأدبية',
    contextEn: 'Al-Qawafi, Al-Heera, and Al-Rafid cultural periodicals.',
    contextAr: 'مجلات القوافي والحيرة والرافد الثقافية.',
    outputEn: 'Issue schedule, peer-reviewed essays & distribution registry',
    outputAr: 'جدول الإصدارات، المقالات المحكمة، وسجل التوزيع',
  },
];
